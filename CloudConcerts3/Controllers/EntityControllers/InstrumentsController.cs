...
namespace CloudConcerts3.Controllers.EntityControllers
{
    public class InstrumentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InstrumentID,Name")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InstrumentID,Name")] Instrument instrument)
        {
            if (ModelState.IsValid)
            {
